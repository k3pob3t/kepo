...
from WhyzuProject.helpers.PyroHelpers import get_ub_chats
from WhyzuProject.utils import extract_user, extract_user_and_reason
...
def globals_init():
    try:
        ...
        sql = import_module("WhyzuProject.helpers.SQL.gban_sql")
        sql2 = import_module("WhyzuProject.helpers.SQL.gmute_sql")
